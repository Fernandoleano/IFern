...
const UPDATE_READY_TEXT: &str = "Update IFern";
...
const VERSION_DEPRECATION_WITHOUT_PERMISSIONS_BANNER_TEXT: &str = "Some IFern features may not work as expected without updating immediately, but IFern is unable to perform the update.";
